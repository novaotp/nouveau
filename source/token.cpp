...
TokenMetadata::TokenMetadata(size_t column, size_t line, size_t length) : column(column),
...
Token::Token(TokenType type, std::string value, TokenMetadata metadata) : type(type), value(value),
    metadata(metadata) {};
